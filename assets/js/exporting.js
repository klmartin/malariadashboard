  ...
  g(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"], a["Core/Color/Palette.js"]], function(a, b) {
    return {
      exporting: {
        ...
        buttons: {
          contextButton: {
            ...
            menuItems: "viewFullscreen printChart separator PNGToBulletin separator downloadPNG downloadJPEG downloadPDF downloadSVG".split(" ")
          }
        },
        menuItemDefinitions: {
          viewFullscreen: {
      ...
      lang: {
        ...
        PNGToBulletin: "Chart to Malaria Bulletin",
