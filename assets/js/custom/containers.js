function containers(data, id, link, base_url, gridstack, auth) {
    ...
    for (let i = 0; i < len; i++) {
        ...
        if (vis.chart_type == 4) {
            ...
            gridstack.addWidget({
                ...
                id: 'lis' + vis.id,
                noMove: true,
                content: '<div class="single_values  chart-container " id="vis_id' + vis.id + '" style="height:100%;width:100%;">' +
                    ...
                    '<a class="dropdown-item" style="display: inline flow-root list-item;" onclick=" comment(0,' + vis.id + ') ">Comment</a>' +
            ...
            gridstack.addWidget({
                ...
                id: 'lis' + vis.id,
                noMove: true,
                content: '<div class=" chart-container " id="vis_id' + vis.id + '" style="height:100%;width:100%;">' +
                    ...
                    '<a  title="Histogram" id="bar' + vis.id + '"  ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638345796609_Pt6_icon.ico" alt=""></a>' +
                    '<a  title="Histogram" id="barstack' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638346501018_ngD_icon.ico" alt=""></a>' +
                    '<a  title="Histogram" id="horizontal' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638345492865_uIR_icon.ico" alt=""></i></a>' +
                    '<a  title="Histogram" id="horizontal_stack' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638343331589_CHp_icon.ico" alt=""></i></a>' +
            ...
            gridstack.addWidget({
                ...
                content: '<div class=" chart-container " id="vis_id' + vis.id + '" style="height:100%;width:100%;">' +
                    ...
                    '<a class="dropdown-item" style="display: inline flow-root list-item;" onclick=" comment(0,' + vis.id + ') ">Comment</a>' +
                    '<a class="dropdown-item" id="edit' + vis.id + '" style="display: inline flow-root list-item;" href="' + link + vis.id + '">Edit</i></a>' +
                    '</div>' +
                    '</div>' +
                    ...
                    '<a   title="Sort" id="a_z_sort' + vis.id + '"  ><i class="fa fa-sort-alpha-asc fa-rotate-270 iconic_chart "></i></a>' +
                    '<a   title="Sort" id="ascending'+ vis.id + '"  ><i class="fa fa-sort-amount-asc fa-rotate-270 iconic_chart"></i></a>' +
                    '<a   title="Sort" id="descending'+ vis.id + '"  ><i class="fa fa-sort-amount-desc fa-rotate-270 iconic_chart"></i></a>' +
                    // '</div>'+
                ...
                var myChart = {
                    chart: {
                        events: {
                            load() {
                                newPoints = [];
                                var points = this.series[0].point
                                const chart = this;
                                chart.showLoading('<div aria-label="Content is loading..." aria-live="polite" role="progressbar" id="preview-loader" class="dhis2loader"></div>');
            ...
            gridstack.addWidget({
                ...
                id: 'lis' + vis.id,
                noMove: true,
                content: '<div class="row  two-charts-container" style="display:inline-flex;padding:1px;width:100%;height:100%;margin:0px" id="vis_id' + vis.id + '">' +
                    ...
                    '<div class="float-left " style="font-size: 14px;width:80%;margin-left: 4px;"> <strong style="float: left;">Proportion:' + vis.title + '</strong></div>' +
                    '<div class="float-right">' +
                    ...
                    '<div class="col-md-12" style="overflow:hidden;position:absolute; bottom:0;width:50%">' +
                    '<div class="row chart-menu">' +
                    '<a  title="Histogram" id="bar_p' + vis.id + '"  ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638345796609_Pt6_icon.ico" alt=""></a>' +
                    '<a  title="Histogram" id="barstack_p' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638346501018_ngD_icon.ico" alt=""></a>' +
                    '<a  title="Histogram" id="horizontal_p' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638345492865_uIR_icon.ico" alt=""></i></a>' +
                    '<a  title="Histogram" id="horizontal_stack_p' + vis.id + '" ><img style="height: 23px;padding: 5px;margin-top: 5px;" src="'+base_url+'1638343331589_CHp_icon.ico" alt=""></i></a>' +
