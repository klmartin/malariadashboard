(function($){
	...
	$.each(all_converter,function(e){
		...
		if (numHyphen < numHyphen_next) {
		    ...
		    item = item + '<i class="fa fa-folder"></i>' + "\n";
	...
	if (typeof(methodName) == "undefined" ) {
		...
		//change symbols
		if (options.collapsedSymbol != "fa-folder") {
		    $(this).find("i").removeClass("fa-folder").addClass(options.collapsedSymbol);
		}
