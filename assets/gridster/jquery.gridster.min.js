        ...
        return (
            ...
            (h.on_stop_drag = function (a, b) {
                ...
                this.set_cells_player_occupies(f, g),
                    ...
                    this.$player.addClass("player-revert").removeClass("player").attr({ "data-col": f, "data-row": g }).css({ left: "", top: "" }),
            ...
            (h.set_dom_grid_height = function (a) {
                ...
                console.log("The height",this.container_height*2)
                return (this.container_height = a), this.$el.css("height", this.container_height*2), this;
            }),
