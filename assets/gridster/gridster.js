/*! gridster.js - v0.7.0 - 2016-02-26 - * https://dsmorse.github.io/gridster.js/ - Copyright (c) 2016 ducksboard; Licensed MIT */ !(function (a, b) {
	...
	let highest_occupied_cell = null;
    "use strict";
    function b(b) {
    ...
    (function (a, b) {
        ...
        "object" == typeof exports
            ...
            ? define("gridster-collision", ["jquery", "gridster-coords"], b)
            : (a.GridsterCollision = b(a.$ || a.jQuery, a.GridsterCoords));
    })(this, function (a, b) {
        "use strict";
        function c(b, c, e) {
            (this.options = a.extend(d, e)), (this.$element = b), (this.last_colliders = []), (this.last_colliders_coords = []), this.set_colliders(c), this.init();
        }
        var d = { colliders_context: document.body, overlapping_region: "C" };
        c.defaults = d;
        var e = c.prototype;
        return (
            (e.init = function () {
            ...
            (e.overlaps = function (a, b) {
                var c = !1,
                    d = !1;
                return (
                    ((b.x1 >= a.x1 && b.x1 <= a.x2) || (b.x2 >= a.x1 && b.x2 <= a.x2) || (a.x1 >= b.x1 && a.x2 <= b.x2)) && (c = !0),
            ...
            (e.calculate_overlapped_area_coords = function (b, c) {
                ...
                return a({ left: d, top: e, width: f - d, height: g - e })
                    .coords()
                    .get();
            }),
            ...
            (e.find_collisions = function (b) {
                for (
                    var c = this,
                        d = this.options.overlapping_region,
                        e = [],
                        f = [],
                        g = this.colliders || this.$colliders,
                        h = g.length,
                        i = c.$element
                            .coords()
                            .update(b || !1)
                    ...
                    if (m) {
                        ...
                        if (n === d || "all" === d) {
                            ...
                            if (0 !== p) {
                                var q = { area: p, area_coords: o, region: n, coords: l, player_coords: i, el: j };
    ...
    (function (a, b) {
        ...
        var c = { items: "li", distance: 1, limit: !0, offset_left: 0, autoscroll: !0, ignore_dragging: ["INPUT", "TEXTAREA", "SELECT", "BUTTON"], handle: null, container_width: 0, move_element: !0, helper: !1, remove_helper: !0 },
            d = a(window),
            e = { x: "left", y: "top" },
        ...
        return (
            ...
            (j.get_offset = function (a) {
                ...
                return (
                    this.options.limit && (e > this.player_max_left ? (e = this.player_max_left) : e < this.player_min_left && (e = this.player_min_left)),
                    {
                        position: { left: e, top: f },
                        pointer: { left: b.left, top: b.top, diff_left: c + (this.$scroll_container.scrollLeft() - this.scroll_container_offset_x), diff_top: d + (this.$scroll_container.scrollTop() - this.scroll_container_offset_y) },
                    }
                );
            }),
            ...
            (j.scroll_in = function (a, b) {
                ...
                var l,
                    m = j ? this.$player.width() : this.$player.height(),
                    ...
                    s = o + b.pointer[d],
                    t = c - k + m;
                return s >= q && ((l = n + h), t > l && (this.$scroll_container[i](l), (this["scroll_offset_" + a] += h))), r >= s && ((l = n - h), l > 0 && (this.$scroll_container[i](l), (this["scroll_offset_" + a] -= h))), this;
            }),
            ...
            (j.on_dragstart = function (a) {
                ...
                return (
                    (this.baseX = Math.round(b.left)),
                    (this.baseY = Math.round(b.top)),
                    "clone" === this.options.helper ? ((this.$helper = this.$player.clone().appendTo(this.$container).addClass("helper")), (this.helper = !0)) : (this.helper = !1),
            ...
            (j.ignore_drag = function (b) {
                return this.options.handle
                    ? !a(b.target).is(this.options.handle)
                    : a.isFunction(this.options.ignore_dragging)
                    ? this.options.ignore_dragging(b)
                    : this.options.resize
                    ? !a(b.target).is(this.options.items)
                    : a(b.target).is(this.options.ignore_dragging.join(", "));
            }),
    ...
    (function (a, b) {
        "use strict";
        "object" == typeof exports
            ? (module.exports = b(require("jquery"), require("./jquery.draggable.js"), require("./jquery.collision.js"), require("./jquery.coords.js"), require("./utils.js")))
            : "function" == typeof define && define.amd
            ? define(["jquery", "gridster-draggable", "gridster-collision"], b)
            : (a.Gridster = b(a.$ || a.jQuery, a.GridsterDraggable, a.GridsterCollision));
    })(this, function (a, b, c) {
        "use strict";
        function d(b, c) {
            (this.options = a.extend(!0, {}, g, c)),
                (this.options.draggable = this.options.draggable || {}),
                (this.options.draggable = a.extend(!0, {}, this.options.draggable, { scroll_container: this.options.scroll_container })),
                (this.$el = a(b)),
        ...
        var f = a(window),
            g = {
                ...
                collision: { wait_for_mouseup: !1 },
                draggable: { items: ".gs-w:not(.static)", distance: 4, ignore_dragging: b.defaults.ignore_dragging.slice(0) },
                resize: { enabled: !1, axes: ["both"], handle_append_to: "", handle_class: "gs-resize-handle", max_size: [1 / 0, 1 / 0], min_size: [1, 1] },
            };
        (d.defaults = g),
        ...
        return (
            ...
            (h.add_widget = function (b, c, d, e, f, g, h, i) {
                var j;
                c || (c = 1), d || (d = 1), e || f ? ((j = { col: e, row: f, size_x: c, size_y: d }), this.options.avoid_overlapped_widgets && this.empty_cells(e, f, c, d)) : (j = this.next_position(c, d));
                var k = a(b).attr({ "data-col": j.col, "data-row": j.row, "data-sizex": c, "data-sizey": d }).addClass("gs-w").appendTo(this.$el).hide();
                ...
                return (
                    this.rows < l && this.add_faux_rows(l - this.rows),
            ...
            (h.resize_widget = function (a, b, c, d) {
                ...
                var f = { col: e.col, row: e.row, size_x: b, size_y: c };
            ...
            (h.expand_widget = function (b, c, d, e, f) {
                ...
                var k = { col: j, row: g.row, size_x: c, size_y: d };
            ...
            (h.collapse_widget = function (a, b) {
                var c = a.coords().grid,
                    ...
                    g = { col: f, row: c.row, size_x: d, size_y: e };
            ...
            (h.fit_to_content = function (a, b, c, d) {
                var e = a.coords().grid,
                    ...
                    l = { col: e.col, row: e.row, size_x: Math.min(b, j), size_y: Math.min(c, k) };
            ...
            (h.center_widgets = debounce(function () {
                ...
                return (
                    0 > e
                        ? (this.get_min_col() > -1 * e ? this.shift_cols(e) : this.resize_widget_dimensions(this.options),
                          setTimeout(
                              a.proxy(function () {
            ...
            (h.mutate_widget_in_gridmap = function (b, c, d) {
                ...
                if (((c.col = d.col), (c.row = d.row), (c.size_x = d.size_x), (c.size_y = d.size_y), this.add_to_gridmap(d, b), b.removeClass("player-revert"), this.update_widget_dimensions(b, d), h.length)) {
            ...
            (h.remove_widget = function (b, c, d) {
                ...
                return (
                    this.remove_from_gridmap(f),
                    this.options.hide_element.call(
                        this,
                        e,
                        a.proxy(function () {
                            e.remove(),
            ...
            (h.register_widget = function (b) {
                ...
                return (
                    this.options.shift_widgets_up && f && ((d.row = f), b.attr("data-row", f), this.$el.trigger("gridster:positionchanged", [d]), (e = !0)),
                    this.options.avoid_overlapped_widgets &&
                        !this.can_move_to({ size_x: d.size_x, size_y: d.size_y }, d.col, d.row) &&
                        (a.extend(d, this.next_position(d.size_x, d.size_y)), b.attr({ "data-col": d.col, "data-row": d.row, "data-sizex": d.size_x, "data-sizey": d.size_y }), (e = !0)),
            ...
            (h.update_widget_position = function (a, b) {
                return (
                    this.for_each_cell_occupied(a, function (a, c) {
            ...
            (h.update_widget_dimensions = function (a, b) {
                ...
                return a.data("coords").update({ width: c, height: d }), a.attr({ "data-col": b.col, "data-row": b.row, "data-sizex": b.size_x, "data-sizey": b.size_y }), this;
            }),
            ...
            (h.on_drag = function (a, b) {
                ...
                var c = this.options.widget_margins,
                    ...
                    f = { left: b.position.left + this.baseX - c[0] * d, top: b.position.top + this.baseY - c[1] * e };
                if (this.options.max_cols === 1 / 0) {
                    var g = this.placeholder_grid_data.col + this.placeholder_grid_data.size_x - 1;
                    g >= this.cols - 1 &&
                        this.options.max_cols >= this.cols + 1 &&
                        (this.add_faux_cols(1), this.set_dom_grid_width(this.cols + 1), this.drag_api.set_limits(this.cols * this.min_widget_width + (this.cols + 1) * this.options.widget_margins[0])),
                ...
                (this.colliders_data = this.collision_api.get_closest_colliders(f)),
                    ...
                    this.helper && this.$player && this.$player.css({ left: b.position.left, top: b.position.top }),
            ...
            (h.on_stop_drag = function (a, b) {
                ...
                (b.position.left = b.position.left + this.baseX - c[0] * d),
                    ...
                    (this.placeholder_grid_data.el.coords().grid.col === this.placeholder_grid_data.col && this.placeholder_grid_data.el.coords().grid.row === this.placeholder_grid_data.row) ||
                        (this.update_widget_position(this.placeholder_grid_data.el.coords().grid, !1),
                        this.options.collision.wait_for_mouseup &&
                            this.for_each_cell_occupied(this.placeholder_grid_data, function (a, b) {
                ...
                var f = this.placeholder_grid_data.col,
                    ...
                    let highest_occupied_cell =  localStorage.getItem("highest_occupied_cell"); 
             
                      if(!g){g=sum([highest_occupied_cell,1])}
                    	if(!f){f=0}


       console.log( 'highest_occupied_cell: '+ highest_occupied_cell)

                    console.log( 'f value: '+f+' g value: ', g)

                this.set_cells_player_occupies(f, g),
                    (this.$player.coords().grid.row = g),
                    (this.$player.coords().grid.col = f),
                    this.$player.addClass('player').attr({ "data-col": f, "data-row": g }).css({ left: "", top: "" }),
            ...
            (h.on_start_resize = function (b, c) {
                (this.$resized_widget = c.$player.closest(".gs-w")),
                    ...
                    this.set_dom_grid_width(this.cols),
                    (this.resize_dir = { right: c.$player.is("." + this.resize_handle_class + "-x"), bottom: c.$player.is("." + this.resize_handle_class + "-y") }),
                    this.is_responsive() || this.$resized_widget.css({ "min-width": this.options.widget_base_dimensions[0], "min-height": this.options.widget_base_dimensions[1] });
            ...
            (h.on_stop_resize = function (b, c) {
                this.$resized_widget.removeClass("resizing").css({ width: "", height: "", "min-width": "", "min-height": "" }),
                    delay(
                        a.proxy(function () {
            ...
            (h.on_resize = function (a, b) {
                var c,
                    ...
                    o = Math.ceil(d / (f + 2 * h) - 0.2),
                    p = Math.ceil(e / (g + 2 * i) - 0.2),
                ...
                !this.resize_dir.bottom && (z.width = Math.max(Math.min(this.resize_initial_width + d, u), v)),
                    ...
                    (q === this.resize_last_sizex && r === this.resize_last_sizey) ||
                        (this.resize_widget(this.$resized_widget, q, r, !1),
                        this.set_dom_grid_width(this.cols),
                        this.$resize_preview_holder.css({ width: "", height: "" }).attr({ "data-row": this.$resized_widget.attr("data-row"), "data-sizex": q, "data-sizey": r })),
            ...
            (h.on_overlapped_column_change = function (b, c) {
                ...
                var d,
                    e = this.get_targeted_columns(this.colliders_data[0].el.data.col),
            ...
            (h.on_overlapped_row_change = function (b, c) {
                if (!this.colliders_data.length) return this;
                var d,
                    e = this.get_targeted_rows(this.colliders_data[0].el.data.row),
            ...
            (h.set_player = function (b, c, d) {
                var e = this,
                    ...
                    h = g.col,
                    i = g.row || c;
                (this.player_grid_data = { col: h, row: i, size_y: this.player_grid_data.size_y, size_x: this.player_grid_data.size_x }),
                    (this.cells_occupied_by_player = this.get_cells_occupied(this.player_grid_data)),
                    (this.cells_occupied_by_placeholder = this.get_cells_occupied(this.placeholder_grid_data));
                        ...
                        a.proxy(function (b, c) {
                            ...
                            if (n.options.collision.wait_for_mouseup && n.drag_api.is_dragging)
                                (n.placeholder_grid_data.col = h),
                                    ...
                                    n.$preview_holder.attr({ "data-row": i, "data-col": h });
                                        ...
                                        if (n.is_swap_occupied(e.col, m.rows[0], e.size_x, e.size_y) || n.is_player_in(e.col, m.rows[0]) || n.is_in_queue(e.col, m.rows[0], d))
                                            if (n.is_swap_occupied(e.col, o, e.size_x, e.size_y) || n.is_player_in(e.col, o) || n.is_in_queue(e.col, o, d))
                                                if (n.is_swap_occupied(m.cols[0], m.rows[0], e.size_x, e.size_y) || n.is_player_in(m.cols[0], m.rows[0]) || n.is_in_queue(m.cols[0], m.rows[0], d))
                                                    ...
                                                    n.options.move_widgets_down_only
                                                        ? j.each(
                                                              a.proxy(function (b, c) {
                                                                  var d = a(c);
                                                                  n.can_go_down(d) &&
                                                                      d.coords().grid.row === n.player_grid_data.row &&
                                                                      !n.is_in_queue(g, e.row, d) &&
                                                                      (n.move_widget_down(d, n.player_grid_data.size_y), n.set_placeholder(h, i));
                                                              })
                                                          )
                                    ...
                                    n.options.move_widgets_down_only
                                        ? j.each(
                                              a.proxy(function (b, c) {
                                                  ...
                                                  n.can_go_down(d) &&
                                                      d.coords().grid.row === n.player_grid_data.row &&
                                                      !n.is_in_queue(d.coords().grid.col, e.row, d) &&
                                                      (n.move_widget_down(d, n.player_grid_data.size_y), n.set_placeholder(h, i));
                                              })
                                          )
                                        : (f = n.queue_widget(m.cols[0], e.row, d));
                            else
                                n.options.shift_larger_widgets_down &&
                                    !f &&
                                    j.each(
                                        a.proxy(function (b, c) {
                                            var d = a(c);
                ...
                return (this.w_queue = {}), { col: h, row: i };
            }),
                ...
                if (e in this.w_queue)
                    if ("full" === this.w_queue[e]) d = !0;
                        ...
                        var f = this.w_queue[e],
                            g = f.coords().grid;
                        this.is_widget_under_player(g.col, g.row)
                            ? this.w_queue[e].attr("data-col") === c.attr("data-col") && this.w_queue[e].attr("data-row") === c.attr("data-row")
                                ? (delete this.w_queue[e], (d = !1))
                                : (d = !0)
                            : (delete this.w_queue[e], (d = !1));
                    }
                return d;
            ...
            (h.widgets_constraints = function (b) {
                ...
                return (
                    ...
                    (c = b.not(e)),
                    { can_go_up: d.sort_by_row_asc(f), can_not_go_up: d.sort_by_row_desc(g) }
                );
            }),
                        ...
                        a.proxy(function (a, b) {
                            ...
                            if (g) this.move_widget_to(f, g), this.set_placeholder(c, g + e.size_y);
                                ...
                                if (!h) {
                                    ...
                                    this.can_go_down(f) && (console.log("In Move Down!"), this.move_widget_down(f, i), this.set_placeholder(c, d));
                                }
                            }
                        }, this)
                    ),
            ...
            (h.is_static = function (a, b) {
                var c = this.gridmap[a];
                return c ? ((c = c[b]), !(!c || !c.hasClass(this.options.static_class))) : !1;
            }),
            ...
            (h.set_placeholder = function (b, c) {
                ...
                if (
                    ((this.placeholder_grid_data.col = b),
                    (this.placeholder_grid_data.row = c),
                    (this.cells_occupied_by_placeholder = this.get_cells_occupied(this.placeholder_grid_data)),
                    this.$preview_holder.attr({ "data-row": c, "data-col": b }),
                    this.options.shift_player_up)
                ) {
                    if (f || g) {
                        var h = this.widgets_below({ col: d.col, row: d.row, size_y: d.size_y, size_x: d.size_x });
                        h.each(
                            a.proxy(function (b, c) {
                                var d = a(c),
                                    e = d.coords().grid,
            ...
            (h.can_go_widget_up = function (a) {
                var b = a.row + a.size_y - 1,
                    ...
                    e = 1e4;
                return (
                    this.for_each_column_occupied(a, function (f) {
            ...
            (h.on_stop_overlapping_column = function (a) {
                var b = this;
                this.options.shift_larger_widgets_down &&
            ...
            (h.move_widget = function (a, b, c, d) {
                var e = a.coords().grid,
                    f = { col: b, row: c, size_x: e.size_x, size_y: e.size_y };
            ...
            (h.move_widget_up = function (b, c) {
                ...
                return (
                    c || (c = 1),
                    this.can_go_up(b)
                        ? void this.for_each_column_occupied(d, function (d) {
                              if (-1 === a.inArray(b, f)) {
                                  var g = b.coords().grid,
                                      h = e - c;
            ...
            (h.can_go_up_to_row = function (b, c, d) {
                ...
                if (
                    ...
                    return !1;
                for (e = d, e = 1; h > e; e++) {
                    for (var i = !0, j = 0, k = g.length; k > j; j++) g[j] && -1 === a.inArray(e, g[j]) && (i = !1);
                    if (i === !0) {
                        f = e;
                        break;
                    }
            ...
            (h.widgets_below = function (b) {
                ...
                var f = this,
                    g = e.row + e.size_y - 1;
                return (
                    this.for_each_column_occupied(e, function (b) {
                        f.for_each_widget_below(b, g, function (b, d) {
                            return f.is_player(this) || -1 !== a.inArray(this, c) ? void 0 : ((c = c.add(this)), !0);
                        });
                    }),
                    d.sort_by_row_asc(c)
                );
            ...
            (h.can_go_down = function (b) {
                var c = !0,
                    d = this;
                return (
                    b.hasClass(this.options.static_class) && (c = !1),
            ...
            (h.can_move_to = function (a, b, c) {
                ...
                if (this.options.max_cols !== 1 / 0) {
                    var g = b + a.size_x - 1;
                    if (g > this.cols) return !1;
                }
                return this.options.max_rows < c + a.size_y - 1
                    ? !1
                    : (this.for_each_cell_occupied(e, function (b, c) {
            ...
            (h.for_each_cell_occupied = function (a, b) {
                return (
                    this.for_each_column_occupied(a, function (c) {
                    ...
                    var l = [],
                        ...
                        n = {
                            ...
                            "for_each/below": function () {
                                for (m = e + 1, i = g[d].length; i > m; m++) this.is_widget(d, m) && -1 === a.inArray(g[d][m], l) && ((h = f.call(g[d][m], d, m)), l.push(g[d][m]));
                            },
                        };
                    n[j] && n[j].call(this);
                }
            ...
            (h.set_dom_grid_height = function (a) {
                if ("undefined" == typeof a) {
                    var b = this.get_highest_occupied_cell().row;
                     let highest_occupied_cell = b;

                    // Store
					localStorage.setItem("highest_occupied_cell", highest_occupied_cell);
            ...
            (h.set_dom_grid_width = function (a) {
                ...
                return (
                    (a = Math.min(b, Math.max(a, this.options.min_cols))),
                    (this.container_width = (a + 1) * this.options.widget_margins[0] + a * this.min_widget_width),
                    this.is_responsive() ? (this.$el.css({ "min-width": "100%", "max-width": "100%" }), this) : (this.$el.css("width", this.container_width), this)
                );
            }),
            ...
            (h.toggle_collapsed_grid = function (a, b) {
                return (
                    a
                        ? (this.$widgets.css({ "margin-top": b.widget_margins[0], "margin-bottom": b.widget_margins[0], "min-height": b.widget_base_dimensions[1] }),
                          this.$el.addClass("collapsed"),
                          this.resize_api && this.disable_resize(),
                          this.drag_api && this.disable())
                        : (this.$widgets.css({ "margin-top": "auto", "margin-bottom": "auto", "min-height": "auto" }), this.$el.removeClass("collapsed"), this.resize_api && this.enable_resize(), this.drag_api && this.enable()),
                    this
                );
            }),
            (h.generate_stylesheet = function (b) {
                ...
                b || (b = {}),
                    ...
                    this.is_responsive() && ((b.widget_base_dimensions = [this.get_responsive_col_width(), b.widget_base_dimensions[1]]), this.toggle_collapsed_grid(f, b));
                var g = a.param(b);
                if (a.inArray(g, d.generated_stylesheets) >= 0) return !1;
                for (this.generated_stylesheets.push(g), d.generated_stylesheets.push(g), c = 1; c <= b.cols + 1; c++)
            ...
            (h.add_faux_cell = function (b, c) {
                ...
                return a.isArray(this.gridmap[c]) || (this.gridmap[c] = []), "undefined" == typeof this.gridmap[c][b] && (this.gridmap[c][b] = !1), this.faux_grid.push(d), this;
            }),
            (h.add_faux_rows = function (a) {
                a = window.parseInt(a, 10);
                for (var b = this.rows, c = b + parseInt(a || 1), d = c; d > b; d--) for (var e = this.cols; e >= 1; e--) this.add_faux_cell(d, e);
            ...
            (h.resize_widget_dimensions = function (b) {
                return (
                    b.widget_margins && (this.options.widget_margins = b.widget_margins),
            ...
            (h.get_widgets_from_DOM = function () {
                ...
                return c.length && this.$el.trigger("gridster:positionschanged"), this;
            }),
            ...
            (h.generate_grid_and_stylesheet = function () {
                ...
                return (
                    this.$widgets.each(function (b, d) {
